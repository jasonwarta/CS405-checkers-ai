...
NN91_Basic::NN91_Basic(std::ifstream &ifs)
{
	std::string line;
...
/*
    ...
    */
NN91_Basic::NN91_Basic(const std::vector<uint> &netSize)
{
...
float NN91_Basic::evaluateNN(std::string &theBoard, bool isRedTeam)
{
	redTeam_ = isRedTeam;
...
float NN91_Basic::SLOWevaluateNN(std::string &theBoard, bool isRedTeam)
{
	redTeam_ = isRedTeam;
	stringToWeightedBoard(theBoard);
	setFirstWeights();
...
void NN91_Basic::printData(std::ostream *os)
{
	(*os) << "net_size ";
...
void NN91_Basic::stringToWeightedBoard(std::string &theBoard)
{
	if (theBoard.size() != 32)
	{
...
void NN91_Basic::setFirstWeights()
{
...
void NN91_Basic::setNeuralSizes(const std::vector<uint> &nodeSizes)
{
...
// Mainly for testing
void NN91_Basic::randomWeights(std::vector<float> &rando)
{
	std::random_device rd;
	std::mt19937 random(rd());
